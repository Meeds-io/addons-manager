  ...
  protected void installAddon(
    ...
    if (addon.mustAcceptLicense && addon.licenseUrl) {
      ...
      if ("eXo".equalsIgnoreCase(addon.vendor)) {
        LOG.warn("DISCLAIMER : You are about to install an eXo Add-On available on your Platform instance.")
        LOG.warn(
        ...
        LOG.warn("DISCLAIMER : You are about to install third-party software available on your Platform instance.")
        LOG.warn(
